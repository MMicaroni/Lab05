...
public class AnagrammiController {
    ...
    void calcolaAnagrammi(ActionEvent event) {
    	...
    	List<String> anagrammiCorretti = model.trovaAnagrammi(parola);
    	List<String> anagrammiErrati = model.anagrammiErrati();
    	String corretti="";
    	String errati="";
    	...
    	txtCorretti.setText(corretti);
    	txtErrati.setText(errati);
